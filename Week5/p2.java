 ...
 * You want to manage RMIT student information using a hash table with the hash function described above. 
 * More specifically, an RMIT student's object is defined as:
 * class RMITStudent {
 * String studentId;
 * String fullName;
 * String major;  
 ...
 * The put method adds an RMIT student object to the hash table, 
 * and the get method accepts a studentId String and returns the appropriate student object matching the given studentId.
 * If the put method is not successful (i.e., the student id is not unique), return false. 
 * If the get method is not successful (i.e., there is no student with the provided id), return null.
